...
- [`СтратегияОграниченияВызовов`](docs/СтратегияОграниченияВызовов.md) (`Rate Limiter`) — ограничивает частоту вызовов, поддерживает ожидание разрешения и равномерное распределение вызовов
