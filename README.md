...
Позволяет применять к пользовательскому `Действие` стратегии повтора, предохранителя, ограничения параллелизма, таймаута, ограничения вызовов и запасного сценария в составе пайплайна.
