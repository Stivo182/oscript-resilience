...
**Стратегии:**
- [`СтратегияПовтора`](docs/СтратегияПовтора.md) (`Retry`) — повторяет операцию при ошибке или по пользовательскому условию
- [`СтратегияПредохранителя`](docs/СтратегияПредохранителя.md) (`Circuit Breaker`) — временно блокирует вызовы к нестабильному ресурсу после сбоев
...
- [`СтратегияТаймаута`](docs/СтратегияТаймаута.md) (`Timeout`) — ограничивает время ожидания завершения операции
- [`СтратегияОграниченияВызовов`](docs/СтратегияОграниченияВызовов.md) (`Rate Limiter`) — ограничивает частоту вызовов и при необходимости распределяет их равномернее
